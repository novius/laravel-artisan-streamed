...
class StreamedLogFile
{
    ...
    public function contentBetweenLines($lineNumberStart, $lineNumberEnd)
    {
        return $this->executeCommand('awk', "NR>$lineNumberStart && NR<=$lineNumberEnd", $this->file);
    }
